...
const Input = React.forwardRef<HTMLInputElement, React.ComponentProps<"input">>(
  ({ className, type, ...props }, ref) => {
    const hasWhiteText = className?.includes('!text-white') || className?.includes('text-white') || props.style?.color === '#ffffff';
    ...
    return (
      <input
        ...
        className={cn(
          ...
          // Si tiene texto blanco, no aplicar bg-background en focus (se maneja con CSS)
