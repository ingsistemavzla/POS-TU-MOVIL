      ...
      <Card className="p-6 bg-[#1a1a1a] border border-[#333]">
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((index) => (
            <div
              key={index}
              className="flex items-center space-x-4 p-4 rounded-lg bg-[#252525] border border-[#333] opacity-50"
            >
              <div className="w-8 h-8 rounded-full bg-[#333] flex items-center justify-center text-sm font-medium text-white flex-shrink-0">
                {index}
              </div>
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 w-full bg-[#333] rounded-full h-2 overflow-hidden">
                  <div className="h-2 rounded-full bg-green-500 transition-all duration-300" style={{ width: '0%' }} />
                </div>
              </div>
      ...
      <div className="space-y-3">
        {displayProducts.map((product, index) => {
          ...
          return (
            <div
              key={product.id}
              className="flex items-center space-x-4 p-4 rounded-lg bg-[#252525] hover:bg-[#2a2a2a] transition-colors border border-[#333]"
            >
              {/* Ranking */}
              <div className="w-8 h-8 rounded-full bg-[#333] flex items-center justify-center text-sm font-medium text-white flex-shrink-0">
                {index + 1}
