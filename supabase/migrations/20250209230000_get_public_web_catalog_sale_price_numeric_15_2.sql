-- ============================================================================
-- QA / Consistencia de tipos: sale_price_usd como numeric(15,2) en la RPC
-- ============================================================================
-- Evita que la API devuelva 95.0000 / 100.0000; la web recibe 95.00 / 100.00.
-- Ver docs/QA_informe_redondeo_base5_rpc.md
-- ============================================================================
...
BEGIN
  ...
  SELECT 
    ...
    -- Precio inflado (RATE o PERCENTAGE) + Redondeo Base 5 → salida numeric(15,2)
    (CASE
...
'Catálogo PÚBLICO. Precio según web_adjustment_method (RATE o PERCENTAGE) + redondeo Base 5. sale_price_usd en numeric(15,2) para API limpia.';
