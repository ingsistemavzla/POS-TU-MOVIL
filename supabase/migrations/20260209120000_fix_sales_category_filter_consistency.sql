-- ============================================================================
-- FIX: Consistencia de filtro por categoría en historial de ventas
-- Fecha: 2026-02-09
-- Problema:
-- - El frontend filtraba categoría sobre ventas paginadas, causando totales inconsistentes.
-- Solución:
-- - Agregar p_category en RPCs para filtrar en backend sobre TODO el rango.
-- ============================================================================
