-- Eliminar la función process_sale antigua para evitar conflictos
DROP FUNCTION IF EXISTS public.process_sale(
  ...
  p_bcv_rate numeric,
  p_customer_id_number character varying,
  p_items jsonb,
  p_notes text,
  p_tax_rate numeric
);

-- Crear la nueva función process_sale con todos los parámetros
